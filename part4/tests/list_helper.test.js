...
describe('total likes', () => {
  ...
  test('when list has six blogs, equals the sum of all likes', () => {
    const result = listHelper.totalLikes(listWithSixBlogs);
    expect(result).toBe(36);
  });
});

test('return the blog with highest number of likes', () => {
  const listWithSixBlogs = [
    {
      _id: '5a422a851b54a676234d17f7',
      title: 'React patterns',
...
test('return the author with most the most number of likes', () => {
  const listWithSixBlogs = [
    {
      _id: '5a422a851b54a676234d17f7',
      title: 'React patterns',
